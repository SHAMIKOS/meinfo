...
<table>
	<tr style="height: 50px;">
		<td style="font-size: 1.8em;"><strong>NAME</strong></td>
		<td style="font-size: 1.5em;"><strong>求职意向：NaN</strong></td>
		<td rowspan="5">
	...
	<tr>
		<td>现住址：Address</td>
		<td>教育背景：Shool and Major</td>
	</tr>
	<tr>
		<td><a href="https://example.com">{{< icon "link" >}}博客主页</a></td>
		<td><a href="https://github.com/example">{{< icon "github" >}}GitHub主页</a></td>
	</tr>
</table>
<hr/>
...
<span>一、公司名称 - 部门</span><span>服务</span><span>时间</span>
</h4>
...
<h4 style="display: flex;justify-content: space-between;">
<span>二、公司名称 - 部门</span><span>服务2</span><span>时间2</span>
</h4>
